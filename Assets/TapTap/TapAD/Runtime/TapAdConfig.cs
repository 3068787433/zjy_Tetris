namespace TapTap.TapAd
{
    public class TapAdConfig
    {
        ...
        public TapAdConfig(long mediaId, string mediaName, string key, bool isDebug, string version, string channel, string tapClientId, string data)
        {
        ...
        public class Builder
        {
            ...
            {
                return new TapAdConfig(_mediaId, _mediaName, _mediaKey, _isDebug, _mediaVersion, _channel, _tapClientId, _data);
            }
        }
    }
}